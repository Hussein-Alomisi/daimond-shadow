    ...
    <section className="relative min-h-screen flex items-center justify-start overflow-hidden pt-20">
      ...
      >
        <Image 
          ...
          fill
          priority
          className="object-cover opacity-40 mix-blend-overlay object-center"
        />
        {/* Gradient Overlay left-to-right fade & bottom-fade for cinematic feel */}
        <div className="absolute inset-0 bg-gradient-to-l from-primary/90 via-primary/60 to-transparent z-10" />
