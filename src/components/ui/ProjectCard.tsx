...
export function ProjectCard({ project, variants, onClick }: ProjectCardProps) {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/40 to-transparent transition-opacity duration-500 group-hover:from-primary group-hover:via-primary/80 group-hover:to-primary/20"
      />

      {/* Gold Accent Lines */}
      <div aria-hidden="true" className="absolute top-0 right-0 h-full w-[3px] bg-gold scale-y-0 origin-top transition-transform duration-500 ease-out group-hover:scale-y-100" />
      <div aria-hidden="true" className="absolute bottom-0 left-0 w-full h-[3px] bg-gold scale-x-0 origin-right transition-transform duration-500 ease-out group-hover:scale-x-100" />
        ...
        <div className="transform translate-y-6 opacity-80 transition-all duration-500 ease-out group-hover:translate-y-0 group-hover:opacity-100">
          ...
          {project.location && (
            <div className="flex items-center text-white/70 text-sm overflow-hidden h-0 opacity-0 transition-all duration-500 delay-100 group-hover:h-6 group-hover:opacity-100 mt-2">
              <svg
                aria-hidden="true"
                className="w-4 h-4 ml-2 text-gold/80 shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
